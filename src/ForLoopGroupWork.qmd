...
* Since the occupancy rate data are derived from derivation rather than direct statistical data, the accuracy of the data will be affected to some extent.
