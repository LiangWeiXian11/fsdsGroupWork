...
df_other.loc[df.availability_365 > 0, 'estimated_annual_income'] = df['estimated_annual_nights'] * df_geq_0.price

# Filling any missing values in both new columns with 0
df_other[['estimated_annual_nights', 'estimated_annual_income']] = df[['estimated_annual_nights', 'estimated_annual_income']].fillna(0)
```
...
df_other['tourists_expenditure'] = df['number_of_beds'] * df['estimated_annual_nights'] * 100
df_other.head(4)
```
...
df_other.loc[df.local_or_company==1,'value_to_local_economy']=df.loc[df.local_or_company==1,'estimated_annual_income']*coef1
df_other.loc[df.local_or_company==0,'value_to_local_economy']=df.loc[df.local_or_company==0,'estimated_annual_income']*coef2

# Update 'value_to_local_economy' by adding the product of 'tourists_expenditure' and 0.43)
df_other['value_to_local_economy'] = df['tourists_expenditure'] * 0.43 + df['value_to_local_economy']
```
